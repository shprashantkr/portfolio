      ...
      >
        {serviceData.map(({ icon, title, description, link }, index) => (
          ...
          whileHover={{scale:1.05}}
            key={index}
            className="border border-gray-400 rounded-lg px-8 py-12 hover:-translate-y-1 diration-500 cursor-pointer hover:bg-[#fcf4ff] hover:shadow-[4px_4px_4px_rgba(0,0,0,0.4)] dark:hover:bg-darkHover dark:hover:shadow-white"
          >
